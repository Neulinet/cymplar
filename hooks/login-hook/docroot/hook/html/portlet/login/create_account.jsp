...
<%
	...
	signInURL = HttpUtil.addParameter(signInURL, "windowState", LiferayWindowState.NORMAL.toString());
...
<aui:form action="<%= createAccountURL %>" method="post" name="fm" cssClass="form-horizontal create-account">
	...
	<aui:fieldset column="<%= true %>">
			...
			<p> By submitting registration form you confirm you agreed with our <a href="/terms" target="_blank">Terms Of Use</a>.
	</aui:fieldset>
